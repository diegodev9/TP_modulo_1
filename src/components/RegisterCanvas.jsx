    ...
    <div className="offcanvas offcanvas-end" tabIndex="-1" id="registerExample"
      ...
      <div className="offcanvas-body">
        <form onSubmit={handleSubmit}>
          <div className="mb-3">
            <label htmlFor="input_nombre" className="col-form-label-sm">Nombre</label>
            <input type="text" className="form-control" id="input_nombre" placeholder="Juan Evaristo"/>
          </div>
          <div className="mb-3">
            <label htmlFor="input_apellido" className="col-form-label-sm">Apellido</label>
            <input type="text" className="form-control" id="input_apellido" placeholder="Pérez Ocampo"/>
          </div>
          <div className="mb-3">
          ...
          <div className="mb-3">
            <label htmlFor="input_telefono" className="col-form-label-sm">Teléfono</label>
            <input type="tel" className="form-control" id="input_telefono" placeholder="Pérez Ocampo"/>
          </div>
          <div className="mb-3">
